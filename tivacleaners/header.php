		...
		<header class="header">
			<div class="header__container">
				...
				<div class="header__menu menu">
					...
					<nav class="menu__body">
						<ul class="menu__list">
							...
							<li class="menu__item">
								<a href="#" class="menu__link" data-goto-header data-goto="#about">About</a>
							</li>
							<li class="menu__item">
								<a href="#" class="menu__link" data-goto-header data-goto="#reviews">Reviews</a>
							</li>
							<li class="menu__item">
				...
				<div class="header__actions">
					<a href="tel:+18252887200" class="header__phone">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="26" viewBox="0 0 16 16">
