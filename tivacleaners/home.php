...
<?php get_header();?>
	        ...
	        <section class="offer">
          <img
            src="<?php bloginfo('template_url'); ?>/assets/img/main_bg.jpg"
            class="offer__bg"
          ...
          <div class="offer__container">
            ...
            <div class="offer__calculator calculator">
              <div class="calculator__services">
                ...
                <div class="service" data-service-price="30" data-service="1">
                  <div class="service__img">
                    <img
                      src="<?php bloginfo('template_url'); ?>/assets/img/calculator/service1.png"
                      alt="service icon"
                    />
                  </div>
                ...
                <div class="service" data-service-price="55" data-service="2">
                  <div class="service__img">
                    <img
                      src="<?php bloginfo('template_url'); ?>/assets/img/calculator/service3.png"
                      alt="service icon"
                    />
                  </div>
                  <p>Window cleaning</p>
                ...
                <div class="service" data-service-price="20" data-service="3">
                  <div class="service__img">
                    <img
                      src="<?php bloginfo('template_url'); ?>/assets/img/calculator/service4.png"
                      alt="service icon"
                    />
                  </div>
                  <p>Lawn mowing</p>
                ...
                <div class="service" data-service-price="30" data-service="4">
                  <div class="service__img">
                    <img
                      src="<?php bloginfo('template_url'); ?>/assets/img/calculator/service5.png"
                      alt="service icon"
                    />
                  </div>
                ...
                <div class="service" data-service-price="30" data-service="5">
                  <div class="service__img">
                    <img
                      src="<?php bloginfo('template_url'); ?>/assets/img/calculator/service6.png"
                      alt="service icon"
                    />
                  </div>
                ...
                <div class="service" data-service-price="30" data-service="6">
                  <div class="service__img">
                    <img
                      src="<?php bloginfo('template_url'); ?>/assets/img/calculator/service7.png"
                      alt="service icon"
                    />
                  </div>
                ...
                <div data-spollers class="spollers calculator__spollers">
                  <div class="spollers__item" data-service-filters="1">
                    <button
                      type="button"
                      data-spoller
                      class="spollers__title _spoller-active"
                    >
                    ...
                    <div class="spollers__body">
                      <div class="block-row">
                        ...
                        <div class="block-row__desc">
                          <p>
                            Choose your home size or select hourly for partial
                            cleanings, large, builders and extra dirty homes.
                            For move in/out please make sure to select the
                            option in the extras section. If square footage
                            exceeds parameters, you may be subject to additional
                            charges.
                          </p>
                        </div>
                        ...
                        <div class="calculator__rooms">
                          <div
                            class="room living-quarters"
                            data-room-price="110"
                          >
                            <div class="room__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/house1.png"
                                alt="house image"
                              />
                            </div>
                          ...
                          >
                            <div class="room__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/house2.png"
                                alt="house image"
                              />
                            </div>
                          ...
                          >
                            <div class="room__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/house3.png"
                                alt="house image"
                              />
                            </div>
                          ...
                          >
                            <div class="room__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/house4.png"
                                alt="house image"
                              />
                            </div>
                          ...
                          >
                            <div class="room__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/house5.png"
                                alt="house image"
                              />
                            </div>
                        ...
                        <div class="bedrooms">
                          ...
                          <div class="bedrooms__block">
                            <div
                              class="bedrooms__item"
                              data-bedroom-price="169"
                            >
                              <div class="bedrooms__img">
                                <img
                                  src="<?php bloginfo('template_url'); ?>/assets/img/calculator/bedroom.png"
                                  alt="bedroom icon"
                                />
                              </div>
                              1
                      ...
                      <div class="block-row">
                        ...
                        <div class="select-extras">
                          <div
                            class="select-extras__item living-extras"
                            data-extras-price="20"
                          >
                            <div class="select-extras__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/oven.png"
                                alt="oven icon"
                                width="64"
                                height="64"
                              />
                          ...
                          >
                            <div class="select-extras__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/fridge.png"
                                alt="fridge icon"
                                width="64"
                                height="64"
                              />
                          ...
                          <div
                            class="select-extras__item living-extras"
                            data-extras-price="10"
                          >
                            <div class="select-extras__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/pets.png"
                                alt="pets icon"
                                width="64"
                                height="64"
                              />
                            </div>
                            <div class="select-extras__desc">Pets in home</div>
                          </div>
                          <div
                            class="select-extras__item living-extras"
                            data-extras-price="10"
                          >
                            <div class="select-extras__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/dishes.png"
                                alt="Dishes icon"
                                width="64"
                                height="64"
                              />
                          ...
                          >
                            <div class="select-extras__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/basement.png"
                                alt="basement icon"
                                width="64"
                                height="64"
                              />
                          ...
                          >
                            <div class="select-extras__img">
                              <img
                                src="<?php bloginfo('template_url'); ?>/assets/img/calculator/carpet.png"
                                alt="carpet icon"
                                width="64"
                                height="64"
                              />
                      ...
                      <div class="block-row">
                        ...
                        <div class="cleaning-level">
                          ...
                          <button
                            class="switsh-btn cleaning-level-deep"
                            id="clDeep"
                          >
                            Deep
                          </button>
                      ...
                      <div class="number-windows">
                        ...
                        <div class="number-windows__renge">
                          <div
                            ...
                            data-to="30"
                            data-price-window="7"
                            data-price-exterior-window="10"
                            data-price-one-window="25"
                            class="range"
                          ></div>
                        </div>
                      </div>
                      ...
                      <div class="lawn-area">
                        <div class="lawn-area__item" data-lawn-area="15">
                          <div class="lawn-area__img">
                            <img
                              src="<?php bloginfo('template_url'); ?>/assets/img/calculator/lawn.png"
                              alt="lawn icon"
                              width="48"
                              height="48"
                            />
                  ...
                  <div class="spollers__item" data-service-filters="5">
                    ...
                    <div class="spollers__body">
                      ...
                      <div class="block-row">
                        ...
                        <button class="switsh-btn is-furniture">YES</button>

                        <div
                          class="renovation-extras__wrap"
                          style="display: none"
                        >
                          ...
                          <div class="select-extras">
                            <div
                              class="select-extras__item renovation-extras"
                              data-extras-price="20"
                            >
                              <div class="select-extras__img">
                                <img
                ...
                <div class="payment-options">
                  ...
                  <div class="payment-options__text">
                    <p>
                      ...
                      anytime. The first booking will not include a discount as
                      we need to familiarize ourselves with your home.
                    </p>
                  </div>
                  <div class="payment-options__variants">
                    <label class="payment-options__option" for="oneTime"
                      >One time</label
                    >
                    <label class="payment-options__option" for="monthly"
                      >Monthly (5%off)</label
                    >
                    <label class="payment-options__option" for="biweekly"
                      >Biweekly (7%off)</label
                    >
                    <label class="payment-options__option" for="weekly"
                      >Weekly (7%off)</label
                    >
                  </div>
                </div>
                  ...
                  <div class="calculator__form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input
                        ...
                        id="aptSuite"
                        aria-describedby="Apt/Suite Help"
                        name="aptSuite"
                      />
                    </div>
              ...
              <div class="calculator__btn-group">
                <button
                  type="button"
                  class="btn btn-primary calculator__btn-prev"
                  style="display: none"
                >
                  PREVIOUS STEP
                </button>
                <button
                  type="button"
                  class="btn btn-primary calculator__btn-next"
                >
                  Next step
                </button>
              </div>
            ...
            <div class="about-content">
              <div class="about-content__body">
                ...
                <p class="about-content__text">
                  House cleaning chores can seem like a never-ending list of
                  tasks. Whether you need daily, weekly, bi-weekly or even a
                  monthly house cleaning schedule, TIVA Cleaning is here to
                  lessen the stress of day-to-day cleaning demands. With
                  cleaning off your plate, you can focus on those things that
                  matter the most to you. We take pride in our professional home
                  cleaning services, including our attention to detail, advanced
                  techniques and keen eye for areas often overlooked.
                </p>
              </div>
        ...
        <section class="advantages">
          <div class="advantages__container">
            <h2 class="advantages__heading section-heading">WHY CHOOSE US</h2>
            <div class="advantages__content">
              <div class="advantages__item row-reverse">
                <div class="advantages__item-img">
                  <img
                    class="advantages__img"
                    src="<?php bloginfo('template_url'); ?>/assets/img/do_it_right.jpg"
                    alt=""
                  />
                </div>
                <div class="advantages__item-text">
                  ...
                  <p class="advantages__item-body">
                    Our employees all have a thorough background check, and we
                    are insured to protect our customers should any accidental
                    damages occur
                  </p>
                </div>
              </div>
              <div class="advantages__item">
                <div class="advantages__item-img">
                  <img
                    class="advantages__img"
                    src="<?php bloginfo('template_url'); ?>/assets/img/buketTools.jpg"
                    alt=""
                  />
                </div>
                <div class="advantages__item-text">
                  ...
                  <p class="advantages__item-body">
                    We come fully prepared, so you don’t need to buy supplies.
                    Ask about our green eco products options!
                  </p>
                </div>
              </div>
              <div class="advantages__item row-reverse">
                <div class="advantages__item-img">
                  <img
                    class="advantages__img"
                    src="<?php bloginfo('template_url'); ?>/assets/img/woman-worker.jpg"
                    alt=""
                  />
                </div>
                <div class="advantages__item-text">
                  ...
                  <p class="advantages__item-body">
                    Our Highly Trained employees won’t need to come back a
                    second time. We take pride in our work and do the job right
              ...
              <div class="advantages__item">
                ...
                <div class="advantages__item-text">
                  <h3 class="advantages__item-title">Professional Cleaners</h3>
                  <p class="advantages__item-body">
              ...
              <div class="advantages__item row-reverse">
                ...
                <div class="advantages__item-text">
                  <h3 class="advantages__item-title">Secured and Insured</h3>
                  <p class="advantages__item-body">
          ...
          <div class="reviews__container">
            ...
            <div class="reviews__content">
              <div class="reviews__item">
                ...
                <img
                  class="reviews__item-grade"
                  src="<?php bloginfo('template_url'); ?>/assets/img/star-rating.svg"
                  alt=""
                />
        ...
        <section class="book">
          <div class="book__container">
            ...
            <form action="" class="book__form" id="bookForm">
              ...
              <label class="book__form-labele" for="bookForm"
                >BOOK A CLEANING</label
              >
              <div class="book__form-upper">
                <div class="book__form-group upper-group">
                  ...
                  <input
                    type="text"
                    class="input book__input book__input-name"
                    id="bookUserName"
                    name="bookUserName"
                    placeholder="Name*"
                  />
                ...
                <div class="book__form-group upper-group">
                  ...
                  <input
                    type="email"
                    class="input book__input book__input-email"
                    id="bookEmail"
                    placeholder="Email*"
                    required="required"
                    aria-required="true"
                ...
                <div class="book__form-group upper-group">
                  ...
                  <input
                    type="tel"
                    class="input book__input book__input-phone"
                    id="bookPhone"
                    placeholder="Phone"
                    required="required"
                    aria-required="true"
                    pattern="[0-9()#&+*-=.]+"
                    name="bookPhone"
                    title="Only numbers and phone symbols (#, -, *, і etc.) are accepted."
                  />
                </div>
              </div>
              ...
              <div class="book__form-group lower-group">
                ...
                <textarea
                  class="input book__input book__input-ms"
                  id="bookMessage"
                  name="bookMessage"
                  rows="3"
                  placeholder="Message"
