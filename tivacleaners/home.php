  ...
  <section class="offer">
    ...
    <div class="offer__container">
      ...
      <div class="offer__calculator calculator">
        ...
        <div class="calculator__square" style="display: none">
          ...
          <div class="payment-options">
            ...
            <div class="payment-options__variants">
              <label class="payment-options__option _setected" for="oneTime" data-discont-procent="0">One time</label>
              <label class="payment-options__option" for="monthly" data-discont-procent="5">Monthly (5%off)</label>
              <label class="payment-options__option" for="biweekly" data-discont-procent="7">Biweekly (7%off)</label>
              <label class="payment-options__option" for="weekly" data-discont-procent="7">Weekly (7%off)</label>
            </div>
          </div>
        </div>
        ...
        <div class="calculator__discount">Discount price: <span>0</span><strong>$</strong></div>
