                            ...
                            <div class="spollers__body">
                                ...
                                <div class="block-row">
                                    ...
                                    <div class="cleaning-level">
                                        <button class="switsh-btn is-deep">
                                            Deep
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="reviews__content">
                <div class="reviews__item">
                    ...
                    <p class="reviews__item-body">
                        ...
                        glad I found them. They did everything I asked for
                        and more!
                    </p>
                </div>
                <div class="reviews__item">
                    ...
                    <p class="reviews__item-body">
                        ...
                        different place. (from the mess) Also, they are
                        meticulous and organi,e things! Axtually think they
                        should be interior designers
                    </p>
                </div>
                <div class="reviews__item">
                    <div class="reviews__item-icon">
                    ...
                    <p class="reviews__item-body">
                        ...
                        exceptionally thorough and we left the apartment in
                        even better condition than when we moved in! AP Good
                        Cleaning will be our first call the next time we need
                        housecleaning.
                    </p>
                </div>
                <div class="reviews__item">
                    ...
                    <p class="reviews__item-body">
                        ...
                        estimate. After our first cleaning with A & P we were
                        really impressed with the attention to detail and
                        value of the girls cleaning services. Highly
                        recommend!!
                    </p>
                </div>
            </div>
