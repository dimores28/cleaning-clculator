				...
				<div class="calculator__square" style="display: none">
							...
							<div class="spollers__body">
								...
								<div class="block-row">
									...
									<div class="cleaning-level">
										<button class="switsh-btn is-deep">Deep</button>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="spollers__body">
								<div class="number-windows">
									...
									<div class="number-windows__renge">
										<div id="rangeWindows" data-from="0" data-to="30" data-price-window="7" data-price-exterior-window="10" data-price-one-window="25" class="range"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="spollers__item" data-service-filters="5">
							...
							<div class="spollers__body">
								...
								<div class="block-row">
									...
									<div class="cleaning-level">
										<button class="switsh-btn is-repair-clinlevel">
											Deep
										</button>
									</div>
								</div>
					...
					<div class="payment-options">
						...
						<div class="payment-options__variants">
							<label class="payment-options__option" for="oneTime">One time</label>
							<label class="payment-options__option" for="monthly">Monthly (5%off)</label>
							<label class="payment-options__option" for="biweekly">Biweekly (7%off)</label>
							<label class="payment-options__option" for="weekly">Weekly (7%off)</label>
						</div>
					</div>
				</div>
					...
					<form>
						<div class="calculator__form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" id="firstName" required="required" aria-required="true" placeholder="First name*" aria-label="First name" />
							</div>
							...
							<div class="input-group">
								...
								<input type="tel" class="form-control" id="userPhone" placeholder="+182xxxxx*" required="required" aria-required="true" pattern="[0-9()#&+*-=.]+" aria-describedby="userPhone" />
							</div>

							<div class="input-group">
								<label for="userEmail">Email address*</label>
								<input type="email" class="form-control" placeholder="example@mail.com*" required="required" aria-required="true" id="userEmail" aria-describedby="emailHelp" />
							</div>

							<div class="input-group">
								<label for="userAddres">Addres*</label>
								<input type="text" class="form-control" placeholder="Addres*" required="required" aria-required="true" id="userAddres" aria-describedby="Addres Help" />
							</div>

							<div class="input-group">
								<label for="aptSuite">Apt/Suite</label>
								<input type="text" class="form-control" placeholder="Apt/Suite #" id="aptSuite" aria-describedby="Apt/Suite Help" />
							</div>

							<div class="input-group">
								<label for="userCity">City*</label>
								<input type="text" class="form-control" placeholder="City*" required="required" aria-required="true" id="userCity" aria-describedby="City Help" />
							</div>
							...
							<div class="input-group">
								...
								<input type="text" class="form-control datapicker" id="cleaningDate" placeholder="Date" aria-label="cleaning date" />
							</div>

							<div class="input-group">
								<label for="timeInput">Time:</label>
								<input type="text" class="form-control" id="timeInput" placeholder="Enter time (hh:mm)" aria-describedby="time Help" />
							</div>

							<div class="input-group">
								<label for="streetAddress">Message</label>
								<textarea id="message" class="form-control form-textarea" placeholder="Message"></textarea>
							</div>

							<div class="input-group">
								<fieldset>
									<div class="payment-swith">
										<input type="radio" id="oneTime" name="payment" value="One time" />
