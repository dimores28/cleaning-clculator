                  ...
                  <div class="select-extras">
                    <?php foreach(getExtras() as $extra) {?>
                      ...
                      <div class="select-extras__item living-extras" data-extras-price="<?php echo $extra["Extras-priceprice"];?>">
                        <span class="select-extras__help" data-tippy-content="<?php echo $extra["info_text"];?>">
                    ...
                    <div class="post__img">
                        <a href="<?php echo get_the_permalink(); ?>">
                          ...
                          if(has_post_thumbnail()) {
                              ...
                              <img width="480" height="320" src="<?php bloginfo('template_url'); ?>/assets/img/blog/post1.jpg" alt="Post thumbnail" />
                          <?php } ?>
                        </a>
                    </div>
