				...
				<div class="footer__content">
					<div class="footer__contacts">
						...
						<ul class="contacts">
							<li class="contacts__item">
								<a href="https://goo.gl/maps/g1emVUuC1TKwgNTZ7" class="contacts__link" target="_blank">
							...
							<li class="contacts__item">
								...
								<a href="tel:+18252887200" class="contacts__link">
									<span>825-288-7200</span>
								</a>
								<a href="tel:+18252887202" class="contacts__link">
									<span class="margin-left">825-288-7202</span>
								</a>
							</li>
						</ul>
					</div>
					...
					<div class="footer__more-info">
						...
						<ul class="more-info">
							...
							<li class="more-info__item">
								<a href="mailto:info@tivacleaners.com" class="more-info__link">
					...
					<div class="footer__fol-us">
						...
						<ul class="fol-us">
							<li class="fol-us__item">
								<a href="mailto:info@tivacleaners.com" class="fol-us__link">
