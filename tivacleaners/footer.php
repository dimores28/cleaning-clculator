		...
		<div class="footer__container">
			...
			<div class="footer__content">
				...
				<div class="footer__contacts">
					<ul class="footer__contacts_list contacts">
						<li class="contacts__item">
							<a href="mailto:info@tivacleaners.com" class="contacts__linck">
								<svg class="contacts__icon">
									<use xlink:href="<?php bloginfo('template_url'); ?>/assets/img/icons/icons.svg#email"></use>
								</svg>
								<span>info@tivacleaners.com</span>
							</a>
						</li>
						<li class="contacts__item">
				...
				<div class="footer__map" id="map">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2508.780584660748!2d-114.09191550000001!3d51.03867309999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53716fd8b74ad911%3A0x87a85568292afeeb!2zMTUxNSAxMiBTdCBTVywgQ2FsZ2FyeSwgQUIgVDJUIDBCOCwg0JrQsNC90LDQtNCw!5e0!3m2!1suk!2sua!4v1685914575399!5m2!1suk!2sua" width="450" height="450" style="border: 0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
				</div>
			</div>
		</div>

		<div class="footer__policy">© Name 2023. All rights reserved</div>
	</footer>
