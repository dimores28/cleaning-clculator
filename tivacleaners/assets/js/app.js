 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            modules_flsModules.rangeWindows = rangeWindows;
            if (rangePipe) {
            ...
            modules_flsModules.rangePipe = rangePipe;
            if (numberWindows) {
            ...
            modules_flsModules.numberWindows = numberWindows;
            if (rangeCarpet) {
            ...
            modules_flsModules.rangeCarpet = rangeCarpet;
        }
        rangeInit();
        ...
        modules_flsModules.numberWindows?.noUiSlider.on("update", (function(values, handle) {
        ...
        $("#inside-pr").on("click", (function() {
            $(this).toggleClass("_select");
            if ($(this).hasClass("_select") && $("#outside-pr").hasClass("_select")) exteriorWindowPR = true; else exteriorWindowPR = false;
            if ($(this).hasClass("_select")) $('[name="renovationWindowsInside"]').val("Inside"); else $('[name="renovationWindowsInside"]').val("");
            updateAllRepairCleanPrice();
            updetePrice();
        }));
        $("#outside-pr").on("click", (function() {
            $(this).toggleClass("_select");
            if ($(this).hasClass("_select") && $("#inside-pr").hasClass("_select")) exteriorWindowPR = true; else exteriorWindowPR = false;
            if ($(this).hasClass("_select")) $('[name="renovationWindowsOutside"]').val("Outside"); else $('[name="renovationWindowsOutside"]').val("");
            updateAllRepairCleanPrice();
            updetePrice();
        }));
        ...
        $(".calculator__btn-next").on("click", (function() {
            ...
            if (hasLawnSelect && step === 2 && !checkSelectedLawnSize() && !checkSelectedGardeningSize()) {
                $(".calculator__alerts").fadeIn("slow");
                $(".calculator__alerts").text("To continue, please select a lawn area or a garden area!");
                return;
            }
            ...
            if (hasCarpetClining && step === 2 && !checkSelectedCarpedCLevel() && !checkSelectedCarpedArea()) {
                $(".calculator__alerts").fadeIn("slow");
                $(".calculator__alerts").text("Please select carpet size and degree of cleaning to continue!");
                return;
            }
        ...
        function checkSelectedCarpedCLevel() {
            ...
            if (carpetLevel.length) return true; else return false;
        }
        function checkSelectedCarpedArea() {
            const carpetArea = document.querySelectorAll(".carpet__item._select");
            if (carpetArea.length) return true; else return false;
        }
        ...
        function updeteHomeCleaningPrice() {
            homeCleaningPrice = parseInt(roomPrice) + parseInt(bedroomsPrice) + parseInt(extrasPrice) + parseInt(bathroomsPrice) + parseInt(receptionPprice);
        }
        ...
        $(".is-window").on("click", (function() {
            ...
            if (!$('[name="renovationWindowsOutside"]').val()) $('[name="renovationWindowsOutside"]').val("Outside"); else $('[name="renovationWindowsOutside"]').val("");
        }));
        ...
        function exteriorWindows() {
            ...
            const numberWindow = parseInt(modules_flsModules.rangeWindows?.noUiSlider.get());
        ...
        $('[data-service="2"]').on("click", (function() {
            if ($(this).hasClass("_select")) {
                ...
                windowsPrice = 0;
                modules_flsModules.rangeWindows?.noUiSlider.set(0);
        ...
        modules_flsModules.rangeWindows?.noUiSlider.on("update", (function(values, handle) {
            const price = $("#rangeWindows").attr("data-price-window");
            const price2 = $("#rangeWindows").attr("data-price-exterior-window");
            const departurePrice = $("#rangeWindows").attr("data-price-one-window");
        ...
        modules_flsModules.rangePipe?.noUiSlider.on("update", (function(values, handle) {
        ...
        $('[data-service="6"]').on("click", (function() {
            if ($(this).hasClass("_select")) modules_flsModules.popup.open("#popup");
        }));
        ...
        $(".carpet__level").on("click", (function() {
            ...
            switch (val) {
              case 1:
                levelText = "Almost Clean (Easy Carpet Cleaning)";
                break;

              case 2:
                levelText = "Dirty (Requires thorough cleaning)";
                break;

              case 3:
                levelText = "Very dirty (Thorough cleaning with chemicals)";
                break;

              case 4:
                levelText = "Complex specific pollution (thorough cleaning with special equipment and complex chemistry)";
                break;
        ...
        function updetePrice() {
            ...
            if (isRepairClinlevel) dopRepairProcent = repairCleanPrice * 1.25 - repairCleanPrice;
            let finalPrice = parseInt(homeCleaningPrice) + parseInt(dopProcent) + parseInt(windowsPrice) + parseInt(lawnPrice) + parseInt(gardenPrice) + parseInt(pipePrice) + parseInt(snowPrice) + parseInt(carpetPrice) + (parseInt(repairCleanPrice) + parseInt(dopRepairProcent));
